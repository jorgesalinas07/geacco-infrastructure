...
resource "aws_route_table" "base_project_bucket_route_table" {
  vpc_id = aws_vpc.base_project_VPC.id
...
resource "aws_route_table_association" "base_project_bucket_route_table_association" {
  count          = var.subnet_count.cloud_private
  subnet_id      = aws_subnet.base_project_cloud_subnet[count.index].id
  route_table_id = aws_route_table.base_project_bucket_route_table.id
}
...
resource "aws_vpc_endpoint_route_table_association" "base_project_bucket_route_table_association" {
  route_table_id  = aws_route_table.base_project_bucket_route_table.id
